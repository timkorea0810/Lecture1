...
public:
    ...
    void checkEnergy (int base_stamina) {
        int effective_stamina = base_stamina * (1 - fatigue_level);
...
public:
    ...
    float shootingSuccessRate (int base_skill) override {
        float specialized_rate = 0.8f * Player::shootingSuccessRate(base_skill);
    ...
    float tackleSuccessRate(int base_skill) override {
        float specialized_rate = 1.5f * Player::tackleSuccessRate(base_skill);
...
public:
    ...
    float shootingSuccessRate (int base_skill) override {
        float specialized_rate = 2.0f * Player::shootingSuccessRate(base_skill);
    ...
    float tackleSuccessRate(int base_skill) override {
        float specialized_rate = 0.5f * Player::tackleSuccessRate(base_skill);
...
int main() {
    ...
    Defender* kim = new Defender("Minjae Kim");
    kim->checkEnergy(base_stamina_value);
    kim->checkEnergy(base_hydration_value);
    kim->shootingSuccessRate(base_skill_value);
    kim->tackleSuccessRate(base_skill_value);
    ...
    Striker* son = new Striker("Heungmin Son");
    son->checkEnergy(base_stamina_value);
    son->checkEnergy(base_hydration_value);
    son->shootingSuccessRate(base_skill_value);
    son->tackleSuccessRate(base_skill_value);

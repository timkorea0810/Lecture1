...
int main() {
    ...
    // strings are not numeric so it doesn't fit in the get_max_numeric but there's no other compatible functions.
    std::cout << std::endl;
...
//    the template only allows integers.
